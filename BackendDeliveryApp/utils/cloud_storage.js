...
const storage = new Storage({
    projectId: "delivery-udemy-mysql-bc039",
    keyFilename: './serviceAccountKey.json'
});

const bucket = storage.bucket("gs://delivery-udemy-mysql-bc039.appspot.com");

/**
 * Subir el archivo a Firebase Storage
 * @param {File} file objeto que sera almacenado en Firebase Storage
 */
export default function(file, pathImage, deletePathImage) {
